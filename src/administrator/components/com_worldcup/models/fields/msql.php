	...
	public function setup(SimpleXMLElement $element, $value, $group = null)
	{
		...
		if ($return)
		{
			...
			if (empty($this->query))
			{
				...
				$this->context = $this->element['context'] ? (string) $this->element['context'] : '';
...
//print_r($html_filters);
			...
			{
				if (isset($html_filters[$value]) && is_numeric($html_filters[$value]))
				{
...
//echo $query->__toString();
	...
	protected function getOptions()
	{
		...
		$options[] = JHtml::_('select.option', '', '- Select item');
