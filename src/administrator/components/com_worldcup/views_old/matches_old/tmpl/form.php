...
?>
		<tr>
			...
			<td>
				<input type="text" name="team1" value="<?php echo $this->matches->team1; ?>">&nbsp;&nbsp;vs&nbsp;&nbsp;
				<input type="text" name="team2" value="<?php echo $this->matches->team2; ?>">
			</td>
    </tr>
<?php
	}
?>
		<tr>
			<td align="right">
				<?php echo JText::_( "Phase" ); ?>
			</td>
			<td>
				<?php echo $this->lists['phases']; ?>
			</td>
    </tr>
		</table>
	</td>
