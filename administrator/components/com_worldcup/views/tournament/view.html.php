...
/**
 * WorldcupViewTournament View
 */
class WorldcupViewTournament extends JViewLegacy
{
	/**
	...
	*/
	protected function addToolBar() 
	{
		...
		JToolbarHelper::save2new('tournament.save2new');
		JToolBarHelper::cancel('tournament.cancel', $isNew ? 'JTOOLBAR_CANCEL'
				                                               : 'JTOOLBAR_CLOSE');
	}
