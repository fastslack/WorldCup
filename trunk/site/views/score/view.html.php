	      ...
	      if($result->local > $result->visit) {
	        ...
	        $game['result'] = "visit";
				...
				if ($result->mid <= 48) {
					...
					$equalmatch = $worldcupConfig['equalmatch'];
					$exactmatch = $worldcupConfig['exactmatch'];
					$simplematch = $worldcupConfig['simplematch'];
		      ...
		      if( ($game['bet'] == "deuce" && $game['result'] == "deuce") && ($bet->local != $result->local) ) {
				...
				## 
					...
					$equalmatch = $worldcupConfig['equalmatch'];
					$exactmatch = $worldcupConfig['exactmatch2'];
					$simplematch = $worldcupConfig['simplematch2'];	
